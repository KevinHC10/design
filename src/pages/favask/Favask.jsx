                          ...
                          <div className="accordion" id="accordionExample">
                              ...
                              >
                                <div className="accordion-body">
                                  <p className="text-muted mb-0 fs-13">
                                    ...
                                    2) 휴대폰 본인확인을 해주세요.
                                    <br />
                                    - 본인 명의의 휴대폰을 보유하고 있지 않으면
                                    회원가입이 불가능합니다.
                                    <br />
                                    - 1인당 최대 3개의 계정을 생성할 수
                                    있습니다.
                                    <br />
                                    <br />
                                    3) 개인정보 수집 및 이용약관에 동의해주세요.
                                    <br />
                                    <br />
                                    4) ID로 사용하실 이메일을 입력해주세요.
                                    <br />
                                    - 이메일을 보유해야만 회원가입이 가능합니다.
                                    <br />
                                    - 등록한 이메일은 변경이 어려우니 신중히
                                    등록해주시기 바랍니다.
                                    <br />
                                    <br />
                                    5) 등록한 이메일로 숫자 6자리로 된
                                    인증번호가 발송됩니다.
                                    <br />
                                    <br />
                                    6) 비밀번호를 입력해주세요.
                                    <br />
                                    - 비밀번호는 영문 대/소문자, 특수문자,
                                    숫자가 포함된 8자리 이상의 번호여야 합니다.
                                    <br />
                                    <br />
                                    7) 보안 비밀번호를 입력해주세요.
                                    <br />
                                    - 보안 비밀번호는 로그인, 출금, 보안 인증 시
                                    사용되므로 타인에게 노출되지 않도록
                                    주의하시기 바랍니다.
                                    <br />
                                    <br />
                                    8) 원활한 거래소 이용을 위해 회원가입 후
                                    고객확인등록 및 실명확인 계좌등록 절차를
                                    완료해주시기 바랍니다.
                                  </p>
                                </div>
                              </div>
                            ...
                            <div className="accordion-item mt-3">
                              ...
                              >
                                <div className="accordion-body">
                                  <p className="text-muted mb-0 fs-13">
                                    회원 탈퇴 후 계정 복구는 불가하오니
                                    주의사항을 확인하시고 탈퇴 신청을 해주시기
                                    바랍니다.
                                    <br />
                                    <br />
                                    만약 스스로 탈퇴가 불가능하시다면 고객센터로
                                    문의하여 주시기 바랍니다.
                                    <br />
                                    <br />
                                    • [PC] 메뉴 &gt; 계정관리 &gt; 회원정보 관리
